...
const SelectBoxes = ({
  strutture,
  tipiDocumento,
  strutturaFilterHandler,
  tipoDocumentoFilterHandler,
}) => {
  return (
    <div className="select-menu-container">
      <div className="bootstrap-select-wrapper">
        <Select
          ...
          onChange={(event) => strutturaFilterHandler(event.label)}
          options={strutture}
      ...
      <div className="bootstrap-select-wrapper">
        <Select
          id="selectExampleClassic"
          onChange={(event) => tipoDocumentoFilterHandler(event.label)}
