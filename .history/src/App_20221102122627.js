...
const App = () => {
  ...
  const onChangeFilter = (struttura) => {
    setStrutturaFilter(struttura.value);
    // console.log(struttura);

    const aiuto = strutture.filter((value) => {
      return Number(value.id) === Number(strutturaFilter);
    });

    // console.log(aiuto);
    // console.log(strutturaFilter);
    console.log(struttura.value);

    // console.log(struttura.target.value);
  };
