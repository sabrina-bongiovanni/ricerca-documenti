    ...
    function ViewportProvider(props) {
        ...
        _this.renderChildren = function (props) {
            ...
            return (React.createElement(React.Fragment, null,
                _this.state.hasListeners && (React.createElement(ViewportCollector, { ref: _this.collector, onUpdate: _this.triggerUpdateToListeners, onIdledUpdate: function (state, updates) {
                        return _this.triggerUpdateToListeners(state, updates, { isIdle: true });
                    } })),
                React.createElement(ViewportContext.Provider, { value: _this.contextValue }, _this.props.children)));
        };
        _this.state = {
            hasListeners: false,
        };
...
var ObserveViewport = /** @class */ (function (_super) {
    ...
    ObserveViewport.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(ViewportContext.Consumer, null, this.registerViewportListeners),
    ...
    return function (WrappedComponent) {
        ...
        return _a = /** @class */ (function (_super) {
                ...
                ConnectViewport.prototype.render = function () {
                    var _this = this;
                    return (React.createElement(ObserveViewport, { disableScrollUpdates: shouldOmitScroll, disableDimensionsUpdates: shouldOmitDimensions, deferUpdateUntilIdle: deferUpdateUntilIdle, priority: options.priority }, function (_a) {
                        var scroll = _a.scroll, dimensions = _a.dimensions;
                        return (React.createElement(WrappedComponent, __assign({ scroll: scroll, dimensions: dimensions }, _this.props)));
                    }));
                };
...
function useViewportEffect(handleViewportChange, second, third) {
    var _a = React.useContext(ViewportContext), addViewportChangeListener = _a.addViewportChangeListener, removeViewportChangeListener = _a.removeViewportChangeListener, hasRootProviderAsParent = _a.hasRootProviderAsParent;
...
var useViewport = function (options) {
    if (options === void 0) { options = {}; }
    var getCurrentViewport = React.useContext(ViewportContext).getCurrentViewport;
    var _a = React.useState(getCurrentViewport()), state = _a[0], setViewport = _a[1];
...
function useLayoutSnapshot(recalculateLayoutBeforeUpdate, second, third) {
    var _a = sortArgs(second, third), options = _a.options, deps = _a.deps;
    var _b = React.useState(null), state = _b[0], setSnapshot = _b[1];
...
var useOptions = function (o) {
    var optionsRef = React.useRef(Object.create(null));
...
exports.ObserveBoundingClientRect = ObserveBoundingClientRect;
exports.ObserveViewport = ObserveViewport;
exports.VERSION = VERSION;
exports.ViewportProvider = ViewportProvider;
exports.cancelAnimationFrame = cancelAnimationFrame;
exports.connectViewport = connect;
exports.requestAnimationFrame = requestAnimationFrame;
exports.useDimensions = useDimensions;
exports.useDimensionsEffect = useDimensionsEffect;
exports.useLayoutSnapshot = useLayoutSnapshot;
exports.useRect = useRect;
exports.useRectEffect = useRectEffect;
