 ...
 */
export declare type ChangesType = {
    added: string | null;
    removed: string | null;
};
/**
 ...
 */
export declare type useNavScrollArgs = {
    /**
 ...
 */
export declare type RegisteredAttributes<T extends Element> = {
 ...
 */
export declare type useNavScrollResult = {
    /**
...
export declare type TrackedElement = {
    id: string;
} & Required<Pick<RegisterOptions, 'ref'>> & Pick<RegisterOptions, 'parent'>;
